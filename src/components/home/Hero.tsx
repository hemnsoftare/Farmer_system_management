    ...
    <div className="flex sm:mt-12 overflow-hidden above-405:px-3 mt-0 items-center w-full justify-between ">
      <div className="flex w-full md:w-[300px] justify-center flex-col py-4 h-full items-center gap-8">
        ...
        <Link href={"#newProducts"} className="transition-all duration-300">
          <button className="capitalize px-4 py-2 text-10 sm:text-20 -mb-6 above-405:px-7 sm:hover:bg-red-800 duration-300 transition-all md:px-12 lg:px-16 bg-secondary text-white  sm:py-4 rounded-lg mt-auto">
            explore more
          </button>
        </Link>
      </div>
      ...
      <Image
        src={"hero.svg"}
        alt="image hero"
        className="mr-0 xl:w-[60%] scale-[1.24] w-[210px] h-[260px]  sm:h-auto self-end lg:w-[55%] sm:w-[60%] "
        width={628}
        height={400}
      />
    </div>
