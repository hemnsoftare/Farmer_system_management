...
const Footer = () => {
  return (
    <>
      <div className="bg-gradient-to-t to-primary-800  via-primary-800 from-primary-700 flex-col flex text-white px-[108px] py-[20px] justify-between items-center">
        <div className="flex justify-between w-full items-center">
          <FooterItem />
          <div className="flex flex-col w-fit px-12  items-center gap-4">
            ...
            <fieldset className="relative border group w-[280px] focus-within:border-blue-700 border-gray-300 px-2 rounded-lg">
              <legend className="text-blue-700 absolute bg-purple-950  -top-3 left-2 text-sm hidden group-focus-within:block duration-300 transition-all  px-2">
                E-mail address
              </legend>
      ...
      <div className="bg-primary-800 w-full px-[100px] flex justify-between">
